...
- **Created:** 2023-09-22
- **Last push:** 2026-07-18 (was 2026-07-03, 2026-06-21, 2026-06-11, 2026-05-20 at prior surveys)
- **Latest release:** `9.147.0` (2026-07-18; was `9.133.0` on 2026-07-03, `9.123.0` on 2026-06-21, `9.113.0` on 2026-06-11, `9.90.0` on 2026-05-20 — 14 minor releases in 15 days, same Renovate self-bump cadence through semantic-release)
- **Stars / Forks / Watchers:** 3 / 1 / 3 (steady)
- **Open issues:** 64 (was 66, 61, 62; long-lived autoheal / Renovate dependency dashboard noise, oscillating in the low-to-mid 60s)
- **Template repository:** created from `bfra-me/github-action` (bfra-me's TypeScript GitHub Action template) — confirmed via API `template_repository` field 2026-07-18
...
- Installs runtime tools (yq, Node, Bun, pnpm, Yarn) that Renovate's package managers may invoke. Pinned tool versions at 2026-07-18: yq `v4.53.3`, Node `24.18.0`, Bun `bun-v1.3.6`, pnpm `11.13.0`, Yarn `4.17.1` — each carries its own `# renovate:` comment so the self-Renovate loop keeps them current independently of `RENOVATE_VERSION`.
...
- **Agent version:** `fro-bot/agent@v0.93.1` (SHA `a4976f45a51458c349eb232aa1795f6fa25d5500`) as of 2026-07-18; was `v0.82.0` (SHA `77d6a464`) on 2026-07-03, `v0.73.0` (SHA `df121025`) on 2026-06-21, `v0.60.0` (SHA `f2f3c08f`) on 2026-06-11, and `v0.44.2` (SHA `b97877b2`) at the 2026-05-20 survey — an 11-minor jump in 15 days, still at the ecosystem's bleeding edge.
...
Extends:
- `github>bfra-me/.github:internal.json5#v4.16.37` (was `#v4.16.33` on 2026-07-03, `#v4.16.27` on 2026-06-21, `#v4.16.25` on 2026-06-11, `#v4.16.18` on 2026-05-20) — bfra-me org's internal Renovate preset
...
| Tool | Version (2026-07-18; prior survey value in parens where changed) |
| --- | --- |
| Node.js | 24.18.0 (steady) (`engines.node` in package.json) |
| pnpm | **11.13.0** (was 11.9.0) |
| TypeScript | 6.0.3 (steady) |
| ESLint | 10.7.0 (was 10.6.0), extends `@bfra.me/eslint-config@0.51.1` |
| Prettier | 3.9.5 (was 3.9.4), extends `@bfra.me/prettier-config/120-proof@0.16.9` |
| tsup | 8.5.1 (bundler, ESM output, license-aware via `esbuild-plugin-license@1.2.3`) |
| Vitest | 4.1.10 (was 4.1.9), `@vitest/eslint-plugin@1.6.23` |
| `@actions/core` | 3.0.1 (only runtime dep) |
| semantic-release | 25.0.7 (was 25.0.5) with `@semantic-release/changelog@6.0.3`, `@semantic-release/git@10.0.1`, `semantic-release-export-data@1.2.0`, `conventional-changelog-conventionalcommits@9.3.1` |
...
| Fro Bot agent | v0.93.1 as of 2026-07-18 (v0.82.0 on 2026-07-03, v0.73.0 on 2026-06-21, v0.60.0 on 2026-06-11, v0.44.2 at first survey — newest in ecosystem all five times) | v0.76.2 (per 2026-06-25 survey) | v0.43.1 (frozen; Renovate targeting v0.92.1 at 2026-07-16) |
...
- **Agent version leadership — confirmed across five surveys.** At first survey (2026-05-20) this repo led the ecosystem on `fro-bot/agent@v0.44.2`; then `v0.60.0` (2026-06-11), `v0.73.0` (2026-06-21), `v0.82.0` (2026-07-03), and now `v0.93.1` (2026-07-18) — the highest pin observed anywhere in the wiki each time. The canary hypothesis holds across all five checkpoints: this repo absorbs agent updates first, almost certainly because its self-Renovate loop (`renovate.yaml` running the action against itself) merges bumps continuously. For reference the parked [[bfra-me--ha-addon-repository]] (frozen on `main`, agent pin v0.43.1) had Renovate targeting `v0.92.1` at its 2026-07-16 survey — this repo was already past that at v0.93.1 two days later, so the canary lead over the rest of the fleet persists.
