...
- [[bfra-me--works]] — `@bfra-me` tooling monorepo (pnpm 10.34.1, TS 6, ESM, Node 24.16); 9 published packages (`eslint-config`, `prettier-config`, `tsconfig`, `es`, `create`, `badge-config`, `doc-sync`, `semantic-release`, `workspace-analyzer`) + Astro Starlight docs; 11 workflows; Fro Bot agent v0.60.0 (fleet-leading pin — 13 automerged bumps 2026-05-31→06-10); `bfra-me/.github` reusable renovate workflow + Renovate baseline at v4.16.25; Changesets publish PR #3652 pending, 3 Fro Bot-authored PRs awaiting review
