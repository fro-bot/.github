...
- [[marcusrbrown--marcusrbrown]] — GitHub profile README with TypeScript-powered automation (badge generation, sponsor tracking, A/B testing, scheduled updates); **Fro Bot onboarded 2026-06-02** via single-file three-mode `fro-bot.yaml` (agent v0.50.0, #924) — closes the long-standing onboarding gap; `mrbro-bot[bot]` still owns generated-content commits, `@bfra.me/eslint-config` trailing item resolved (0.51.1), pnpm 10.34.1, Node 24.16.0
