...
- [[marcusrbrown--esphome-life]] — ESPHome device firmware repo: Olimex ESP32-PoE-ISO Bluetooth Proxies for Home Assistant; CI builds via `esphome/build-action@v7.3.0`, GitHub Pages firmware installer; Renovate autopilot at `#5.2.1`, `bfra-me/.github` reusable workflows v4.16.23; no Fro Bot workflow; `update-repo-settings.yaml` footgun (calls renovate workflow instead of settings workflow, persisting since 2026-05-26)
