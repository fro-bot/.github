...
- [[marcusrbrown--containers]] — Container collection and automation framework (Dockerfiles, multi-arch builds, Python CLI, AI-powered templates, CI/CD); Renovate preset crossed v4→v5 boundary 2026-05-20 (`#5.2.0`), Fro Bot agent advanced to v0.44.0, dockerfile syntax v1.24, urllib3 CVE patch floor, `poetry lock` added to postUpgradeTasks
