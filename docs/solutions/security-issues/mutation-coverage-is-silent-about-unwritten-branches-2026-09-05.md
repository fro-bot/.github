...
symptoms:
  - A Tier 0 privacy-boundary parser reached 118 killed / 0 survived / 0 no-coverage / 0 directives while still carrying a reachable false negative
...
disclosure. PR #3837 drove it to 118 killed / 0 survived / 0 no-coverage / 0 directives — Stryker's
strongest possible signal — while `line.startsWith('+++')` still routed **any** line starting with
...
right gets re-done, not preserved. #3837's 34 tests all passed and its two `BooleanLiteral`
